...
<table>
	...
	<?php _e('Adds up to 4 fields to the bbp user profile and displays any combination of these under the authors avatar in topics and replies ', 'bbp-style-pack'); ?> 
	</td></tr>
...
<?php _e('This is just a list! I offer no warranty that these work as described, or work together.', 'bbp-style-pack'); ?>
	...
	<tr><td style="width:250px">	
	<a href = "https://wordpress.org/plugins/moderation-tools-for-bbpress/">bbPress – Moderation Tools </a>
	</td><td>
	<?php _e('Add the ability to moderate and approve new topics and replies in bbPress', 'bbp-style-pack'); ?> 
	</td></tr>
	...
	<tr><td style="width:250px">	
	<a href = "https://wordpress.org/plugins/bbp-messages/">bbPress Messages</a>
	</td><td>
	<?php _e('bbPress Messages - User Private Messages with notifications, widgets and media with no BuddyPress needed. ', 'bbp-style-pack'); ?> 
	</td></tr>
	...
	<tr><td style="width:250px">	
	<a href = "https://wordpress.org/plugins/bbp-valoration/">bbp-valoration</a>
	</td><td>
	<?php _e('Adds thumbsup, visits and replies count to topics on bbpress, display results on a widget.', 'bbp-style-pack'); ?> 
	</td></tr>
