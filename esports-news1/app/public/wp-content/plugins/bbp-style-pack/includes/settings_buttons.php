...
function bsp_style_settings_buttons () {
	...
	<Form method="post" action="options.php">
		<?php wp_nonce_field( 'style-settings_buttons', 'style-settings-nonce' ) ?>
		<?php settings_fields( 'bsp_style_settings_buttons' );
...
<!-- PROFILE BUTTON  -->	
	...
	<!-- BUTTON STYLING -->					
		...
		<tr>
			<td style="vertical-align:top">
				...
				<label class="description">
					<?php _e( '<i>(You can style the button below)</i>' , 'bbp-style-pack' ); ?>
				</label>
			</td>
			...
			<td style="vertical-align:top">
				...
				<br>
				<label class="description">
					<?php _e( '<i>(Use a class from your theme - the button will use the style from the class below.)</i>' , 'bbp-style-pack' ); ?>
				</label>
			</td>
		</tr>
		...
		<tr>
			...
			$value2 = (!empty($bsp_style_settings_buttons[$name.$area2]) ? $bsp_style_settings_buttons[$name.$area2]  : '') ;
			...
			$value5 = (!empty($bsp_style_settings_buttons[$name.$area5]) ? $bsp_style_settings_buttons[$name.$area5]  : '') ;
			$value6 = (!empty($bsp_style_settings_buttons[$name.$area6]) ? $bsp_style_settings_buttons[$name.$area6]  : '') ;
	...
	?>
		...
		<tr>
			<td style="vertical-align:top">
				<?php _e ('Subcribe' , 'bbp-style-pack' ) ; ?>
			</td>
	...
	<p>
		<b>
		<?php _e( 'Further Help', 'bbp-style-pack' ); ?>
		</b>
	</p>
	<p>
	...
	<p>
		<?php _e( 'So for instance if you go to <a href= "http://css3buttongenerator.com/" >http://css3buttongenerator.com/</a>  you can create a button.  This will generate code for a class of \'btn\'.  Copy this code to the \'custom css\' tab of this plugin, then select \'Use Class\' above and put \'btn\' in the class box above. ', 'bbp-style-pack' ); ?>
<?php
}
